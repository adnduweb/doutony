            ...
            t = $("#kt_apps_logsConnexions_list_datatable").KTDatatable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        type: "success",
                        template: function(t) {
                                var success = (t.success == '1') ? '<span class="btn btn-bold btn-sm btn-font-sm  btn-label-success">' + _LANG_.cool_success + '</span>' : '<span class="btn btn-bold btn-sm btn-font-sm  btn-label-danger">' + _LANG_.error + '</span>';
