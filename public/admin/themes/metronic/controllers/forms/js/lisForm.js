"use strict";
var kt_apps_forms_list_datatable = function() {
    var t;
    return {
        init: function() {
            t = $("#kt_apps_forms_list_datatable").KTDatatable({
                data: {
                    type: "remote",
                    source: {
                        read: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        width: 200,
                        template: function(t) {
                            return '<a href="javascript:;" class="capitalize text-dark-75 font-weight-bolder font-size-lg mb-0">' + t.handle + '</a>';
                        }
                    ...
                    {
                        field: "telephone",
                        title: _LANG_.telephone,
                        type: "telephone",

                    },
                    {
                        field: "subject",
                        title: _LANG_.subject,
                        type: "subject",
                        ...
                        template: function(t) {
                            ...
                            template += '<li class="kt-nav__item">\
                                    <a href="#" data-controller="form" data-action="actionView" data-module="false" data-value="' + t.uuid_form + '" class="actioncontroller kt-nav__link">\
                                    <i class="kt-nav__link-icon flaticon2-expand"></i>\
                                    <span class="kt-nav__link-text">' + _LANG_.view + '</span>\
                                    </a></li>';

                            template += ' <li class="kt-nav__item">\
                            <a href="#" data-id="' + t.uuid_form + '" class="deleterowKtdatatable kt-nav__link">\
                        ...
                        $.ajax({
                            ...
                            success: function(result, status, xhr) {
                                ...
                                if (xhr.status == 200) {
                                    ...
                                    $("#kt_apps_forms_list_datatable").KTDatatable().reload();
                                }
                            }
                        })
                    } else {
...
KTUtil.ready(function() {
    kt_apps_forms_list_datatable.init()
});