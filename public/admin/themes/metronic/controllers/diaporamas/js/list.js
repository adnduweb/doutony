"use strict";
var KTAppDiaporamasListDatatable = function() {
    var t;
    return {
        init: function() {
            t = $("#kt_apps_diaporamas_list_datatable").KTDatatable({
                data: {
                    type: "remote",
                    source: {
                        read: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        <li class="navi-item">\
                        <a href="' + startUrl + '/public/diaporamas/edit/' + t.id + '" class="navi-link">\
                        ...
                        $.ajax({
                            ...
                            success: function(result, status, xhr) {
                                ...
                                if (xhr.status == 200) {
                                    ...
                                    $("#kt_apps_diaporamas_list_datatable").KTDatatable().reload();
                                }
                            }
                        })
                    } else {
...
KTUtil.ready(function() {
    KTAppDiaporamasListDatatable.init();
