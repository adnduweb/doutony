"use strict";
var KTAppCategoriesListDatatable = function() {
    var t;
    return {
        init: function() {
            t = $("#kt_apps_categorie_list_datatable").KTDatatable({
                data: {
                    type: "remote",
                    source: {
                        read: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        template: function(t) {
                            ...
                            var template = '<a href="' + startUrl + '/' + baseSegmentAdmin + '/blog/categories/edit/' + t.id + '" class="capitalize text-dark-75 font-weight-bolder font-size-lg mb-0"> ' + t.name + '</a>';
                            return template;
                        }
                        ...
                        type: "count_product",
                        template: function(t) {
                            var template = '<a href="' + startUrl + '/' + baseSegmentAdmin + '/blog/categories/count/' + t.id + '" class="capitalize text-dark-75 font-weight-bolder font-size-lg mb-0"> ' + t.count_product + ' ' + _LANG_.product + '</a>';
                            return template;
                        }
                        ...
                        <li class="navi-item">\
                        <a href="' + startUrl + '/' + baseSegmentAdmin + '/blog/categories/edit/' + t.id + '" class="navi-link">\
                        ...
                        $.ajax({
                            ...
                            success: function(result, status, xhr) {
                                ...
                                if (xhr.status == 200) {
                                    ...
                                    $("#kt_apps_categorie_list_datatable").KTDatatable().reload();
                                }
                            }
                        })
                    } else {
...
KTUtil.ready(function() {
    KTAppCategoriesListDatatable.init();
