"use strict";
var KTAppBrandListDatatable = function() {
    var t;
    return {
        init: function() {
            t = $("#kt_apps_brand_product_list_datatable").KTDatatable({
                data: {
                    type: "remote",
                    source: {
                        read: {
                            ...
                            params: {
                                ...
                                action: 'list',
                                value: '',
                                module: window.btoa('Adnduweb/Ci4_ecommerce'),
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        width: 200,
                        template: function(t) {
                            var template = '<a href="' + startUrl + '/ecommerce/catalogue/brand/edit/' + t.id + '" class="capitalize text-dark-75 font-weight-bolder font-size-lg mb-0"> ' + t.name + '</a>';
                            return template;
                        }

                    }, {
                        field: "description_short",
                        title: _LANG_.description_short,
                        type: "description_short",
                        template: function(t) {
                            return '<span class="truncated">' + t.description_short + '</span>';
                        }

                    }, {
                        field: "count_product",
                        title: _LANG_.count_product,
                        type: "count_product",
                        template: function(t) {
                            var template = '<a href="' + startUrl + '/ecommerce/catalogue/brand/count/' + t.id + '" class="capitalize text-dark-75 font-weight-bolder font-size-lg mb-0"> ' + t.count_product + ' ' + _LANG_.product + '</a>';
                            return template;
                        }
                        ...
                        template: function(t) {
                            ...
                            $.each(t.languages, function(index, value) {
                                if (value == false) { var active = 'btn-label-danger'; } else { var active = 'btn-label-success'; }
                        ...
                        <a href="' + startUrl + '/ecommerce/catalogue/brand/edit/' + t.id + '" class="kt-nav__link">\
                ...
                if (st == '!1') {
                    $("#changeCategorie").show();
                    $("#changeCategorie select").attr('data-categorieOriginal', a.get());
                    console.log(a.get());
                    return false;
                }
                        ...
                        $.ajax({
                            ...
                            success: function(result, status, xhr) {
                                ...
                                if (xhr.status == 200) {
                                    ...
                                    $("#kt_apps_brand_product_list_datatable").KTDatatable().reload();
                                }
                            }
                        })
                    } else {
...
function changeCategorie($this) {
    var categorie = $($this).val();
    var categorieOriginal = $($this).attr('data-categorieOriginal');
    ...
    $.ajax({
        ...
        data: {
            ajax: true,
            controller: 'AdminBrandController',
            action: 'changeCategorie',
            value: {
                categorie: categorie,
                categorieOriginal: categorieOriginal
            },
            module: window.btoa('Adnduweb/Ci4_ecommerce')
        },
        dataType: "json",
