// $(document).on('click', '.kt_dropzone', function() {
//     //DropZoneManger.autoDiscover = false;
//     var field = $(this).attr('data-field');
//     var id = $(this).attr('id');
//     var acceptedfiles = $(this).attr('data-acceptedfiles');
//     var maxfiles = $(this).attr('data-maxfiles');
//     var maxfilesize = $(this).attr('data-maxfilesize');
...
//     var DropZoneManger = new Dropzone(this, {
...
//         addRemoveLinks: !0,
//         //clickable: ['.conpoment_build *', '.kt_dropzone'],
//         init: function() {
...
//     DropZoneManger.on("addedfile", function(o) {
//         console.log('addedfile');
//     });
//     DropZoneManger.on("sending", function(file, xhr, formData) {

//         formData.append("ajax", true);
//         formData.append("controller", 'AdminMediasController');
...
//     DropZoneManger.on('success', function(file, response) {
...
//         }
//     });
//     DropZoneManger.on("error", function(file, response, xhr) {
...
//         }
//     });
//     DropZoneManger.on("removedfile", function(file, response, xhr) {
...
//             data: {
//                 ajax: true,
//                 controller: 'AdminMediasController',
//                 action: 'deleteFile',
//                 value: {
...
//     $(this).dropzone({
//         url: base_url + 'propiedades/uploadDocumentos/',
...
serviceBlockUploadImage(".kt_dropzone");
// Dropzone.autoDiscover = false;
// $(function() {
//     var myDropzone = new Dropzone("div.kt_dropzone", { url: basePath + segementAdmin + "/sp-admin-ajax?time=" + $.now(), });
            ...
            if (xhr.status == 200) {
                ...
                $('#kt_apps_manager_media').on('submit', function(e) {
                    ...
                    if ($('.upload_id_images').val() != "") {
                        ...
                        var widgetOption = '{"media":{"id_media":' + $("#images-select-manager").val() + ',"filename":"' + $("#files-select-manager").val() + '","format":"' + $("#formats-select-manager").val() + '","extension":"' + $("#extensions-select-manager").val() + '"}}';
