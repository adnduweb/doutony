            ...
            t = $("#kt_apps_company_list_datatable").KTDatatable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        width: 200,
                        template: function(t) {
                            return '<div class="capitalize text-dark-75 font-weight-bolder font-size-lg mb-0"><a href="' + startUrl + '/settings-advanced/company/edit/' + t.uuid_company + '" class="kt-user-card-v2__name text-dark-75 font-weight-bolder font-size-lg mb-0">' + t.raison_social + '</a></div>';
                        }
                        ...
                        template: function(t, e) {
                            ...
                            <span class="kt-user-card-v2__email"> ' + t.adresse + '</span>\
                        ...
                        //width: 100,
                        template: function(t) {
                            return '<div class="capitalize text-dark-75 font-weight-bolder font-size-lg mb-0">' + t.nom_court + '</div>';
                        }
                        ...
                        <li class="navi-item">\
                        <a href="' + startUrl + '/settings-advanced/company/edit/' + t.uuid_company + '" class="navi-link">\
