            ...
            t = $("#kt_apps_pages_list_datatable").KTDatatable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        field: "template",
                        title: _LANG_.template,
                        width: 150,
                        type: "template",
                        template: function(t) {
                            return '<span class="btn btn-bold btn-sm btn-font-sm btn-label-dark">' + t.template + '</span>';
                        }
                        ...
                        width: 100,
                        template: function(t) {
                            if (restrictPage.includes(t.id) == false) { var restrict = false; } else { var restrict = true; }
                            ...
                            var template = '<a href="javascript:;" data-statut="' + idActive + '" data-id="' + t.id + '" data-restrict="' + restrict + '" class="actionActive btn btn-bold btn-sm btn-font-sm ' + active + '">' + textActive + '</a>';
                            return template;
                        ...
                        template: function(t) {
                            ...
                            $.each(t.languages, function(index, value) {
                                if (value == false) { var active = 'btn-light-danger'; } else { var active = 'btn-light-primary'; }
