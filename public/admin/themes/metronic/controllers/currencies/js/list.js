            ...
            t = $("#kt_apps_currency_list_datatable").KTDatatable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        width: 200,
                        template: function(t) {
                            return '<a href="' + startUrl + '/international/currency/edit/' + t.id + '" class="capitalize text-dark-75 font-weight-bolder font-size-lg mb-0"> ' + t.name + '</a>';
                        }
                        ...
                        <li class="navi-item">\
                        <a href="' + startUrl + '/international/currency/edit/' + t.id + '" class="navi-link">\
