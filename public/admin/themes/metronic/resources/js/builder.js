$(document).ready(function() {
    ...
    $(".form_bal_textareafield").draggable({
        helper: function() {
    ...
    $(".form_bal_imageCarouselfield").draggable({
        helper: function() {
            return getImageCarouselFieldHTML();
        },
        connectToSortable: ".form_builder_area"
    });
    ...
    function getTextFieldHTML() {
        ...
        var script = '<script>jQuery(document).ready(function() {var portlet' + field + ' = new KTPortlet("kt_portlet_tools' + field + '", optionsPortlet);  portlet' + field + '.collapse();}); </script>';
    ...
    function getImageFieldHTML() {
        ...
        var script = '<script>jQuery(document).ready(function() {var portlet' + field + ' = new KTPortlet("kt_portlet_tools' + field + '", optionsPortlet);  portlet' + field + '.collapse(); serviceBlockUploadImage("div#kt-dropzone' + field + '");}); </script>';
        html = html.replace('__script__', script);
        var portlet = new KTPortlet("kt_portlet_tools" + field);
    ...
    function getImageCarouselFieldHTML() {
        var field = generateField();
        var html = $('.compoments_imageCarouselfield').html();
        var re = /__field__/gi;
        html = html.replace(re, field);
    ...
    function getTextAreaFieldHTML() {
        ...
        // return $('<div>').addClass('li_' + field + ' form_builder_field').html(html);
        var field = generateField();
        var html = $('.compoments_textareafield').html();
        var re = /__field__/gi;
        html = html.replace(re, field);
        var script = '<script>jQuery(document).ready(function() {var portlet' + field + ' = new KTPortlet("kt_portlet_tools' + field + '", optionsPortlet); portlet' + field + '.collapse();});</script>';
        if (activer_multilangue == 1) {
            ...
            $.each(langues, function(key, value) {
                script += '<script>jQuery(document).ready(function() {ClassicEditor.create(document.querySelector("#content' + field + '_' + value + '"), { language: "' + lang_iso + '" }).then(editor => { console.log(editor); }).catch(error => { console.error(error); });}); </script>';
            });
        } else {
            script += '<script>jQuery(document).ready(function() {ClassicEditor.create(document.querySelector("#content' + field + '_' + lang_iso + '"), { language: "' + lang_iso + '" }).then(editor => { console.log(editor); }).catch(error => { console.error(error); });}); </script>';
        }
